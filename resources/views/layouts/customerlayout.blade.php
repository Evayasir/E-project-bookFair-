...
<!-- Mirrored from templates.iqonic.design/booksto/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2023 07:21:00 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
      ...
      <!-- Bootstrap CSS -->
      <link rel="stylesheet" href="project/dashboard/css/bootstrap.min.css">
      <!-- Typography CSS -->
      <link rel="stylesheet" href="project/dashboard/css/typography.css">
      <!-- Style CSS -->
      <link rel="stylesheet" href="project/dashboard/css/style.css">
      <!-- Responsive CSS -->
      <link rel="stylesheet" href="project/dashboard/css/responsive.css">
   </head>
   <body>
      <!-- loader Start -->
      <div id="loading">
         ...
         <div class="iq-sidebar">
            <div class="iq-sidebar-logo d-flex justify-content-between">
               <a href="index.html" class="header-logo">
                  <img src="project/dashboard/images/logo.png" class="img-fluid rounded-normal" alt="">
                  ...
                  <div class="iq-card">
                     <div class="iq-card-body">
                        <div class="sidebarbottom-content">
                           <div class="image"><img src="project/dashboard/images/page-img/side-bkg.png" alt=""></div>                           
                     ...
                     <ul class="navbar-nav ml-auto navbar-list">
                                 ...
                                 <div class="iq-card-body p-0">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="project/dashboard/images/user/01.jpg" alt="">
                                          </div>
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="project/dashboard/images/user/02.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="project/dashboard/images/user/03.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="project/dashboard/images/user/04.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="project/dashboard/images/user/05.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 toggle-cart-info">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="rounded" src="project/dashboard/images/cart/01.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="rounded" src="project/dashboard/images/cart/02.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="rounded" src="project/dashboard/images/cart/03.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="rounded" src="project/dashboard/images/cart/04.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                        ...
                        <li class="line-height pt-3">
                           <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                              <img src="project/dashboard/images/user/1.jpg" class="img-fluid rounded-circle mr-3" alt="user">
                              <div class="caption">
...
@yield("page_content")
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-lg-6 text-right">
                  Copyright 2023 <a href="#">BookFair</a> All Rights Reserved.
               </div>
            </div>
         </div>
      </footer>
      ...
      <script src="project/dashboard/js/jquery.min.js"></script>
      <script src="project/dashboard/js/popper.min.js"></script>
      <script src="project/dashboard/js/bootstrap.min.js"></script>
      <!-- Appear JavaScript -->
      <script src="project/dashboard/js/jquery.appear.js"></script>
      <!-- Countdown JavaScript -->
      <script src="project/dashboard/js/countdown.min.js"></script>
      <!-- Counterup JavaScript -->
      <script src="project/dashboard/js/waypoints.min.js"></script>
      <script src="project/dashboard/js/jquery.counterup.min.js"></script>
      <!-- Wow JavaScript -->
      <script src="project/dashboard/js/wow.min.js"></script>
      <!-- Apexcharts JavaScript -->
      <script src="project/dashboard/js/apexcharts.js"></script>
      <!-- Slick JavaScript -->
      <script src="project/dashboard/js/slick.min.js"></script>
      <!-- Select2 JavaScript -->
      <script src="project/dashboard/js/select2.min.js"></script>
      <!-- Owl Carousel JavaScript -->
      <script src="project/dashboard/js/owl.carousel.min.js"></script>
      <!-- Magnific Popup JavaScript -->
      <script src="project/dashboard/js/jquery.magnific-popup.min.js"></script>
      <!-- Smooth Scrollbar JavaScript -->
      <script src="project/dashboard/js/smooth-scrollbar.js"></script>
      <!-- lottie JavaScript -->
      <script src="project/dashboard/js/lottie.js"></script>
      <!-- am core JavaScript -->
      <script src="project/dashboard/js/core.js"></script>
      <!-- am charts JavaScript -->
      <script src="project/dashboard/js/charts.js"></script>
      <!-- am animated JavaScript -->
      <script src="project/dashboard/js/animated.js"></script>
      <!-- am kelly JavaScript -->
      <script src="project/dashboard/js/kelly.js"></script>
      <!-- am maps JavaScript -->
      <script src="project/dashboard/js/maps.js"></script>
      <!-- am worldLow JavaScript -->
      <script src="project/dashboard/js/worldLow.js"></script>
      <!-- Raphael-min JavaScript -->
      <script src="project/dashboard/js/raphael-min.js"></script>
      <!-- Morris JavaScript -->
      <script src="project/dashboard/js/morris.js"></script>
      <!-- Morris min JavaScript -->
      <script src="project/dashboard/js/morris.min.js"></script>
      <!-- Flatpicker Js -->
      <script src="project/dashboard/js/flatpickr.js"></script>
      <!-- Style Customizer -->
      <script src="project/dashboard/js/style-customizer.js"></script>
      <!-- Chart Custom JavaScript -->
      <script src="project/dashboard/js/chart-custom.js"></script>
      <!-- Custom JavaScript -->
      <script src="project/dashboard/js/custom.js"></script>
   </body>

<!-- Mirrored from templates.iqonic.design/booksto/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2023 07:21:53 GMT -->
</html>